  ...
  <section className={`${styles.yPaddings} pl-6 sm:pl-16`}>
    <motion.div
      ...
      <motion.div
        ...
        <div className='hero-gradient absolute -top-[30px] z-[0] h-[300px] w-full rounded-t-[140px]' />
        <img
          src='/cover.png'
          alt='cover'
          className='relative z-10 h-[350px] w-full rounded-xl rounded-tl-[140px] object-cover sm:h-[500px]'
        />
        <a href='#explore'>
